...
else{console.log("- nilai min dari angka genap < angka ganjil")}

if (maksimal(angkaGenap) > maksimal(angkaGanjil)) console.log("- nilai max dari angka genap > angka ganjil:")
else{console.log("- nilai max dari angka genap < angka ganjil")}

if (total(angkaGenap) > total(angkaGanjil))
console.log("- nilai total dari angka genap > angka ganjil:")
else{console.log("- niali total dari angka genap < angka ganjil")}

if (rataRata(angkaGenap) > rataRata(angkaGanjil)) console.log("- nilai rata-rata dari angka genap > angka ganjil:")
else{console.log("- nilai rata-rata dari angka genap < angka ganjil")}
